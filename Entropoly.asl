...
state("Entropoly", "1.0.5") {
    int Current_Room: 0x158f4f8;

    string32 obj_gameManager_level_to_load : 0x137c3c8, 0x0, 0x330, 0x18, 0x50, 0x10, 0x48, 0x10, 0x620, 0x0, 0x0, 0x0;

    int obj_bed_Count : 0x137c3c8, 0x0, 0x5f0, 0x18, 0x60;
    double obj_bed_ypos : 0x137c3c8, 0x0, 0x5f0, 0x18, 0x50, 0x10, 0x48, 0x10, 0x290, 0x0;
    double obj_bed_activated : 0x137c3c8, 0x0, 0x5f0, 0x18, 0x50, 0x10, 0x48, 0x10, 0x0, 0x0;

    float obj_player_y : 0x137c3c8, 0x0, 0x640, 0x18, 0x50, 0x10, 0xec;

    ulong obj_level_portal_tetra_Iter : 0x137c3c8, 0x0, 0x7f0, 0x18, 0x50;
    ulong obj_level_portal_cube_Iter : 0x137c3c8, 0x0, 0x800, 0x18, 0x50;
    ulong obj_level_portal_octa_Iter : 0x137c3c8, 0x0, 0x810, 0x18, 0x50;
    ulong obj_level_portal_icosa_Iter : 0x137c3c8, 0x0, 0x820, 0x18, 0x50;
    ulong obj_level_portal_dodeca_Iter : 0x137c3c8, 0x0, 0x830, 0x18, 0x50;

    double obj_finish_tetra_exiting : 0x137c3c8, 0x0, 0x7a0, 0x18, 0x50, 0x10, 0x48, 0x10, 0x490, 0x0;
    double obj_finish_cube_exiting : 0x137c3c8, 0x0, 0x7b0, 0x18, 0x50, 0x10, 0x48, 0x10, 0x490, 0x0;
    double obj_finish_octa_exiting : 0x137c3c8, 0x0, 0x7c0, 0x18, 0x50, 0x10, 0x48, 0x10, 0x490, 0x0;
    double obj_finish_icosa_exiting : 0x137c3c8, 0x0, 0x7d0, 0x18, 0x50, 0x10, 0x48, 0x10, 0x490, 0x0;
    double obj_finish_dodeca_exiting : 0x137c3c8, 0x0, 0x7e0, 0x18, 0x50, 0x10, 0x48, 0x10, 0x490, 0x0;
}

init {
    int moduleSize = modules.First().ModuleMemorySize;
    vars.Debug("Module size: " + moduleSize);
    if (moduleSize == 23449600) {
        version = "1.0.5";
    } else {
...
startup {
    ...
    Func<ulong, Process, Process, bool> IsEnteringPortal = (iter, _game, _memory) => {
        ...
        while (iterPtr != IntPtr.Zero) {
            var pointer = new DeepPointer(iterPtr + 0x10, 0x48, 0x10, 0xc90, 0x0);
    ...
    if(!vars.DeepPointersInitialized) {
        if (version == "1.0.5") {
            vars.current_save_file_Pointer = new DeepPointer(
                0x137c3c8, 0x0, 0x670, 0x18, 0x50, 0x10, 0x48, 0x10, 0x70, 0x0
            );
        }
