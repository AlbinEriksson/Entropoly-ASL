...
state("Entropoly", "1.0.4") {
    int Current_Room: 0x157cc48;

    string32 obj_gameManager_level_to_load : 0x1369b18, 0x0, 0x320, 0x18, 0x50, 0x10, 0x48, 0x10, 0x650, 0x0, 0x0, 0x0;

    int obj_bed_Count : 0x1369b18, 0x0, 0x5d0, 0x18, 0x60;
    double obj_bed_ypos : 0x1369b18, 0x0, 0x5d0, 0x18, 0x50, 0x10, 0x48, 0x10, 0xa0, 0x0;
    double obj_bed_activated : 0x1369b18, 0x0, 0x5d0, 0x18, 0x50, 0x10, 0x48, 0x10, 0x10, 0x0;

    float obj_player_y : 0x1369b18, 0x0, 0x620, 0x18, 0x50, 0x10, 0xec;;

    ulong obj_level_portal_tetra_Iter : 0x1369b18, 0x0, 0x7d0, 0x18, 0x50;
    ulong obj_level_portal_cube_Iter : 0x1369b18, 0x0, 0x7e0, 0x18, 0x50;
    ulong obj_level_portal_octa_Iter : 0x1369b18, 0x0, 0x7f0, 0x18, 0x50;
    ulong obj_level_portal_icosa_Iter : 0x1369b18, 0x0, 0x800, 0x18, 0x50;
    ulong obj_level_portal_dodeca_Iter : 0x1369b18, 0x0, 0x810, 0x18, 0x50;

    double obj_finish_tetra_exiting : 0x1369b18, 0x0, 0x780, 0x18, 0x50, 0x10, 0x48, 0x10, 0x4c0, 0x0;
    double obj_finish_cube_exiting : 0x1369b18, 0x0, 0x790, 0x18, 0x50, 0x10, 0x48, 0x10, 0x4c0, 0x0;
    double obj_finish_octa_exiting : 0x1369b18, 0x0, 0x7a0, 0x18, 0x50, 0x10, 0x48, 0x10, 0x4c0, 0x0;
    double obj_finish_icosa_exiting : 0x1369b18, 0x0, 0x7b0, 0x18, 0x50, 0x10, 0x48, 0x10, 0x4c0, 0x0;
    double obj_finish_dodeca_exiting : 0x1369b18, 0x0, 0x7c0, 0x18, 0x50, 0x10, 0x48, 0x10, 0x4c0, 0x0;
}

init {
    int moduleSize = modules.First().ModuleMemorySize;
    vars.Debug("Module size: " + moduleSize);
    if (moduleSize == 23367680) {
        version = "1.0.4";
    } else {
...
startup {
    ...
    Func<ulong, Process, Process, bool> IsEnteringPortal = (iter, _game, _memory) => {
        ...
        while (iterPtr != IntPtr.Zero) {
            var pointer = new DeepPointer(iterPtr + 0x10, 0x48, 0x10, 0xcc0, 0x0);
    ...
    if(!vars.DeepPointersInitialized) {
        if (version == "1.0.4") {
            vars.current_save_file_Pointer = new DeepPointer(
                0x1369b18, 0x0, 0x650, 0x18, 0x50, 0x10, 0x48, 0x10, 0x1b0, 0x0
            );
        }
